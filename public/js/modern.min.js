$(document).ready(function() {
    ...
    var t = document.querySelector(".fixed-header-check"),
        ...
        b = function() {
            $("body").hasClass("small-sidebar") && 1 == d.checked && d.click(), $("body").hasClass("page-header-fixed") || 0 != t.checked || t.click(), $("body").hasClass("page-sidebar-fixed") && 1 == i.checked && i.click(), $("body").hasClass("page-horizontal-bar") && 1 == l.checked && l.click(), $("body").hasClass("compact-menu") && 1 == h.checked && h.click(), $("body").hasClass("hover-menu") && 1 == u.checked && u.click(), $(".page-content").hasClass("container") && 1 == r.checked && r.click(), $(".theme-color").attr("href", "assets/css/themes/green.css"), c()
        },
        p = $(".navbar .logo-box a span").text(),
        m = p.slice(0, 1),
        g = function() {
            $("body").toggleClass("small-sidebar"), $(".navbar .logo-box a span").html($(".navbar .logo-box a span").text() == m ? p : m), c()
        },
        f = function() {
    ...
    if ($(".small-sidebar .navbar .logo-box a span").html($(".navbar .logo-box a span").text() == m ? p : m), $(".theme-settings").length || $(".sidebar-toggle").click(function() {
            g()
